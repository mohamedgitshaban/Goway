...
class TripResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'traffic_surge_multiplier' => (float) ($this->billing_breakdown['traffic_surge_multiplier'] ?? 1.0),
            'traffic_surge_amount' => (float) ($this->billing_breakdown['traffic_surge_amount'] ?? 0.0),
            'traffic_delay_minutes' => (float) ($this->billing_breakdown['traffic_delay_minutes'] ?? 0.0),
            'has_traffic' => (bool) ($this->billing_breakdown['has_traffic'] ?? false),
            'has_tolls' => (bool) ($this->billing_breakdown['has_tolls'] ?? false),
            'toll_amount' => (float) ($this->billing_breakdown['toll_amount'] ?? 0.0),
